    ...
    <>
      <div className='pag1'>
        ...
        <P>
          ...
          Concluiu a <Input name='serie' type='number' value={campos.serie && campos.serie[0]} onChange={changeField} maxLength='1' min='1' max='9' style={{width: 50}} />ª série do Ensino fundamental, nos termos da Lei 9.394/46, artigo 24, inciso II, alínea “b”.
        </P>
        ...
        <Center>
          <Input name='formasAcesso1' type='checkbox' value='Classificação' onChange={changeField} />Classificação (Progressão Plena)<br />                              
          <Input name='formasAcesso2' type='checkbox' value='Reclassificação' onChange={changeField} />Reclassificação<br />
        </Center>
        <P>
          Dispensa em:<br />
        </P>
        <Center>
          Educação Física <Input name='edFisica' type='radio' value='Sim' onChange={changeField} />  Sim <Input name='edFisica' type='radio' value='Não' onChange={changeField} />  Não /
      ...
      <div className='pag2'>
        ...
        Concluiu a {campos.serie && campos.serie[0]}ª série do Ensino fundamental, nos termos da Lei 9.394/46, artigo 24, inciso II, alínea “b”.
        </P>
        ...
        Dispensa em:<br />
        Educação Física ()  Sim ()  Não / Ensino Religioso (   ) Sim  ( x ) Não
        </P>
