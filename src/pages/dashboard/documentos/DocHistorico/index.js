...
const DocHistorico = () => {
  ...
  return (
    <>
    <div className='pag1'>
      <H1>EDUCANDÃRIO SAGRADO CORAÇÃO DE JESUS</H1>
      <PH1>
        EducaçÃ£o Infantil e Ensino Fundamental do 1Âº ao 9Âº Ano<br />
        CNPJ â€“ 05.061.549/0001-00<br />
        Cadastro Escolar: NÂº P â€“ 364.002<br />
        AutorizaçÃ£o portaria â€“ SE NÂº 1874<br />
        Publicado no D.O. de 20/03/03
      </PH1>

      <H2>HistÃ³rico Escolar do Ensino Fundamental</H2>
      <P>
        ...
        Concluiu a <Input name='serie' type='number' value={campos.serie && campos.serie[0]} onChange={changeField} maxLength='1' min='1' max='9' style={{width: 50}} />Âª sÃ©rie do Ensino fundamental, nos termos da Lei 9.394/46, artigo 24, inciso II, alÃ­nea â€œbâ€.
      </P>
      ...
      <Center>
        <Input name='formasAcesso1' type='checkbox' value='ClassificaçÃ£o' onChange={changeField} />ClassificaçÃ£o (ProgressÃ£o Plena)<br />                              
        <Input name='formasAcesso2' type='checkbox' value='ReclassificaçÃ£o' onChange={changeField} />ReclassificaçÃ£o<br />
      </Center>
      <P>
        Dispensa em:<br />
      </P>
      <Center>
        Educação FÃ­sica <Input name='edFisica' type='radio' value='Sim' onChange={changeField} />  Sim <Input name='edFisica' type='radio' value='Não' onChange={changeField} />  Não /
    ...
    <div className='pag2'>
      <H1>EDUCANDÃRIO SAGRADO CORAÇÃO DE JESUS</H1>
      <PH1>
      Educação Infantil e Ensino Fundamental do 1Âº ao 9Âº Ano<br />
      CNPJ â€“ 05.061.549/0001-00<br />
      Cadastro Escolar: NÂº P â€“ 364.002<br />
      Autorização portaria â€“ SE NÂº 1874<br />
      Publicado no D.O. de 20/03/03
      </PH1>
      ...
      Concluiu a {campos.serie && campos.serie[0]}Âª sÃ©rie do Ensino fundamental, nos termos da Lei 9.394/46, artigo 24, inciso II, alÃ­nea â€œbâ€.
      </P>
      ...
      Dispensa em:<br />
      EducaçÃ£o FÃ­sica ()  Sim ()  NÃ£o / Ensino Religioso (   ) Sim  ( x ) NÃ£o
      </P>
